...
function lz_chat_buy_voucher_validate_form()
{
	...
	if(missing)
		lz_chat_chat_alert(lz_chat_data.Language.FillMandatoryFields,lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0',''));
	return !missing;
}
...
function lz_chat_chat_alert(_text,_frame,_event,_buttonText,_showIcon)
{	
	if(lz_chat_data.CallMeBackAlertVisible)
		return;
...
function lz_chat_show_connected()
{
	if(!lz_chat_data.ConnectedMessageAppended)
	{
		...
		if(lz_chat_data.CallMeBackMode)
		{
			lz_chat_chat_alert("<div class=\"lz_chat_call_me_now\"></div><br>" + lz_chat_data.Language.ClientInitInstantCallback + "<br><br>",lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',''),null,null,false);
			lz_chat_data.CallMeBackAlertVisible = true;
		}
	}
}
...
{	
	...
	if(_type == 0)
		...
		text = lz_chat_data.Language.ClientIntLeft + " <a href=\"javascript:parent.parent.lz_chat_unload();parent.parent.lz_chat_goto_message(true,false);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 4)
		text = lz_chat_data.Language.ClientIntDeclined + " <a href=\"javascript:parent.parent.lz_chat_unload();parent.parent.lz_chat_goto_message(true,false);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 5)
		text = lz_chat_data.Language.ClientStillWaitingInt + " <a href=\"javascript:parent.parent.lz_chat_unload();parent.parent.lz_chat_goto_message(true,false);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou; 
	else if(_type == 6)
		text = lz_chat_data.Language.ClientIntIsConnected;
	else if(_type == 8)
		text = lz_chat_data.Language.ClientNoInternUsers + " <a href=\"javascript:parent.parent.lz_chat_unload();parent.parent.lz_chat_goto_message(true,false);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 9)
...
function lz_hide_call_me_back_alert()
{
	if(lz_chat_data.CallMeBackAlertVisible)
	{
		lz_chat_data.CallMeBackAlertVisible = false;
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','').document.getElementById('lz_chat_alert_box').style.display = 'none';
	}
}
