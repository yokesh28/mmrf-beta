function lz_chat_data_box()
{
	...
	this.CallMeBackMode = <!--call_me_back-->;
	this.CallMeBackAlertVisible = false;
	this.PollHash = '';
	this.PollAcid = '';
	this.DynamicGroup = '';
	...
	function lz_chat_data_language()
	{
		...
		this.StartChatComInformation = "<!--lang_client_start_chat_com_information-->";
		...
		this.ClientInitInstantCallback = "<!--lang_client_init_call_me_now-->";
...
function lz_chat_input(_index,_active,_caption,_name,_type,_value,_validation,_validationURL,_validationTimeout,_validationContinueOnTimeout)
{
	this.Index = _index;
	this.Active = _active;
