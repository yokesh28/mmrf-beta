<table cellspacing="0" cellpadding="0" style="margin:0px;padding:0px;border:0px;background-image:url('<!--server-->templates/invitations/<!--template-->/background.gif');background-repeat:no-repeat;background-position:center left;" width="400" height="132" border="0">
	<tr>
...
<input type="text"  value="<!--username-->" maxlength="32" id="lz_invitation_name" style="position:absolute;left:105px;top:104px;background-color:#e0e0e0;background-image:url('<!--server-->templates/invitations/<!--template-->/textbox.gif');background-repeat:no-repeat;border:0px;height:20px;width:164px;font-size:11px;color:#707070;padding-left:3px;line-height:18px;outline:none;">
...
<div style="width:25px;position:absolute;left:370px;top:5px;cursor:pointer;" onclick="top.lz_tracking_close_request();top.lz_tracking_action_result('chat_request',false,true);return false;">&nbsp;</div>