		...
		<td>
			<table cellspacing="0" cellpadding="0">
				<tr>
					...
					<td style="width:22px;cursor:pointer;" onclick="top.lz_tracking_close_request();top.lz_tracking_action_result('chat_request',false,<!--close_on_click-->);return false;">&nbsp;</td>
				</tr>
			</table>
		</td>
	</tr>
