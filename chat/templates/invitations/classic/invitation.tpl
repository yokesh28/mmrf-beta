<table cellspacing="0" cellpadding="0" style="margin:0px;padding:0px;border:0px;background-image:url('<!--server-->templates/invitations/<!--template-->/background.gif');background-repeat:no-repeat;background-position:center left;" width="302" height="220" border="0">
	<tr>
		<td style="margin:0px;padding:0px;border:0px;"></td>
	</tr>
</table>
<div style="width:25px;position:absolute;left:272px;top:5px;cursor:pointer;" onclick="top.lz_tracking_close_request();top.lz_tracking_action_result('chat_request',false,true);return false;">&nbsp;</div>
...
<img style="position:absolute;left:10px;top:38px;" alt="<!--intern_name-->" src="<!--server--><!--intern_image-->" border="0">
