...
<head>
	...
	function ValidateRating()
	{
		...
		{
			parent.parent.lz_chat_chat_alert(parent.parent.lz_chat_data.Language.SelectRating,parent.parent.lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',''),null);
			return;
		}
		...
		{
			parent.parent.lz_chat_chat_alert(parent.parent.lz_chat_data.Language.MessageTooLong + " (-" + (document.getElementById("lz_chat_rate_comment").value.length-400).toString() + ")",parent.parent.lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',''),null);
			return;
		}
		...
		parent.parent.lz_chat_send_rate(lz_chat_rate_settings[0],lz_chat_rate_settings[1],document.getElementById("lz_chat_rate_comment").value);
	}
	
	function RatingCallback(_message)
	{
		parent.parent.lz_chat_switch_rating();
		parent.parent.lz_chat_chat_alert(_message,parent.parent.lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',''),null);
	}
