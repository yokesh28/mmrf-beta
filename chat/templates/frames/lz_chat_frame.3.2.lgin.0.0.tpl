...
<head>
	...
	<title><!--config_gl_site_name--> - Live Chat Login</title>
			...
			<td align="right">
				<table cellspacing="0" cellpadding="0">
					<tr>
						...
						<td><img src="./images/button_close.gif" border="0" onclick="parent.parent.close();" class="lz_chat_clickable_image" title="<!--lang_client_close_window-->" alt="<!--lang_client_close_window-->"></td>
